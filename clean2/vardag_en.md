...
- [ ] **3. Mirrors**
  - [ ] Clean all mirrors with a blue microfiber cloth moisten with some water. Mirrors can be found at the toiltes, in the hallway and in the green room.
...
Then use the same cloth to clean the toilet, both outside and inside. Then put the cloth in the laundry basket.
  - [ ] Disinfect everything with "Ytdesinfection" on a <b>paper towel</b>.
...
- [ ] **6. Handles and light switches**
  - [ ] Use the disinfectant on a <b>paper towel</b> and disinfect all handles and light switches in all rooms.
